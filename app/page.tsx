          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="py-12 sm:py-16">
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                ...
                <div className="lg:col-span-1 sm:col-span-2 lg:col-span-1">
                  <div className="text-xl sm:text-2xl font-bold text-primary mb-3 sm:mb-4">Quang Dũng Center</div>
                  ...
                  <div className="flex gap-2 sm:gap-3">
                    {[Facebook, Youtube].map((Icon, index) => (
                      <Button
                        ...
                        size="sm"
                        variant="outline"
                        className="border-primary/20 text-primary hover:bg-primary hover:text-primary-foreground bg-transparent hover:scale-110 transition-transform"
                      >
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="border-primary/20 text-primary hover:bg-primary hover:text-primary-foreground bg-transparent hover:scale-110 transition-transform text-xs sm:text-sm"
                    >
                      Zalo
                    </Button>
                  </div>
                ...
                {/* Quick Links */}
                <div>
                  <h4 className="font-semibold text-card-foreground mb-3 sm:mb-4 text-sm sm:text-base">
                    {t("quickLinks")}
                  </h4>
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-2 group">
                        <contact.icon className="h-3 w-3 sm:h-4 sm:w-4 text-primary group-hover:scale-110 transition-transform flex-shrink-0 mt-0.5" />
                        <span className="text-muted-foreground text-xs sm:text-sm group-hover:text-primary transition-colors">
                          {contact.text}
                        </span>
                      </div>
                    ))}
                ...
                <div>
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <Input
                      placeholder={language === "vi" ? "Nhập email của bạn" : "メールアドレスを入力"}
                      className="bg-background border-border text-foreground focus:ring-2 focus:ring-primary transition-all text-sm"
                    />
                    <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground hover:scale-105 transition-transform text-xs sm:text-sm">
            ...
            <div className="py-4 sm:py-6 border-t border-border">
              <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
                <p className="text-muted-foreground text-xs sm:text-sm text-center sm:text-left">{t("copyright")}</p>
